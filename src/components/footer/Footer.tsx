    ...
    <footer className="w-full bg-slate-950 text-slate-400 mt-auto">
      ...
      <div className="w-full py-16 px-6 md:px-12 lg:px-24 flex justify-center border-b border-slate-900">
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          {/* Quick Links */}
          <div className="flex flex-col gap-6">
            <h4 className="font-medium md:font-bold text-white text-sm uppercase tracking-widest relative pb-2 border-b border-slate-900 w-fit">
              Quick Links
            </h4>
            <ul className="flex flex-col gap-3 font-normal md:font-medium text-xs md:text-sm">
              <li>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 font-normal md:font-medium text-xs md:text-sm">
      ...
      <div className="w-full py-6 px-6 text-center text-[10px] md:text-xs font-medium md:font-semibold text-slate-600">
