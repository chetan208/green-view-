...
export default function ToppersSection() {
  ...
  // Only show top 4 on home page to keep it compact
  const displayedToppers = toppers.slice(0, 4);
    ...
    <section className="py-6 md:py-8 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-5 md:mb-6 max-w-2xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight leading-[1.1] mb-2 text-balance">
          ...
          <p className="text-slate-600 text-xs md:text-sm text-balance">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 md:gap-5 justify-center">
            {displayedToppers.map((topper, index) => (
              <div key={topper._id} className="block">
        ...
        {!loading && toppers.length > 4 && (
          <div className="mt-6 flex justify-center">
            <Link 
              href="/toppers" 
              className="group inline-flex items-center gap-2 bg-white border-2 border-[#006a37]/20 text-[#006a37] px-5 py-2.5 rounded-xl font-bold hover:bg-[#006a37] hover:text-white hover:border-[#006a37] transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#006a37] focus-visible:ring-offset-2"
            >
