    ...
    <section className="w-full bg-white py-12 md:py-20 lg:py-24 px-6 md:px-12 flex justify-center">
      <div className="max-w-6xl w-full flex flex-col items-center gap-12 md:gap-16">
        ...
        <div className="flex flex-col items-center text-center gap-4">
          <span className="text-brand-green font-medium md:font-semibold text-[10px] md:text-xs uppercase tracking-[0.25em]">
            RECOGNITION
          </span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium md:font-bold text-slate-900 tracking-tight leading-tight">
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <h4 className="text-slate-900 font-medium md:font-semibold text-sm md:text-base leading-snug">
                    {award.title}
                  </h4>
