      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="text-center mb-10 md:mb-14 flex flex-col items-center">
          <motion.span 
            ...
            className="text-brand-green font-medium md:font-semibold text-xs md:text-sm uppercase tracking-[0.2em] mb-4"
          >
            OUR JOURNEY
          </motion.span>
          <motion.h2 
            ...
            className="text-3xl md:text-4xl font-medium md:font-bold text-slate-900 tracking-tight"
          >
                ...
                <div key={index} className="relative flex flex-col md:flex-row items-center justify-between py-4 md:py-3 group">
                  ...
                  <div className={`hidden md:flex w-1/2 px-6 lg:px-10 ${isEven ? "justify-end text-right" : "justify-start text-left"}`}>
                    {isEven ? (
                      ...
                      >
                        <h3 className="text-xl lg:text-2xl font-medium md:font-semibold text-brand-green uppercase tracking-wider">{item.title}</h3>
                      </motion.div>
                    ) : (
                      <motion.div 
                      ...
                      >
                        <div className="font-medium md:font-bold text-2xl text-slate-900 mb-2">{item.year}</div>
                  ...
                  <div className="md:hidden flex flex-col pl-16 pr-4 w-full relative">
                    <motion.div 
                      ...
                      className="mb-2 mt-4"
                    >
                      <h3 className="text-lg font-medium md:font-semibold text-brand-green uppercase tracking-wider">{item.title}</h3>
                    </motion.div>
                    <motion.div 
                      initial={{ opacity: 0.3, y: 15 }}
                      whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                      <div className="font-medium md:font-bold text-xl text-slate-900 mb-2">{item.year}</div>
