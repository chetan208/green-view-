      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="hidden sm:block">
              <p className="text-slate-900 font-black text-[13px] leading-none tracking-tight">
                Green View ERP
              </p>
              <p className="text-slate-500 text-[9px] font-semibold uppercase tracking-widest mt-0.5">
        ...
        <div className="flex items-center gap-2 shrink-0">
              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-1.5 w-72 bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden z-25 text-slate-800 p-4 space-y-3">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                    <span className="text-xs font-black text-brand-green-dark">Notifications</span>
                  ...
                  <div className="space-y-2.5 max-h-60 overflow-y-auto pr-1">
                    <div className="p-3 rounded-xl bg-emerald-50/50 border border-emerald-100 text-xs font-semibold text-emerald-800 space-y-1.5 flex gap-2.5 items-start">
                      ...
                      <div>
                        <p className="font-black text-emerald-700">System Active</p>
                        <p className="text-[10px] text-emerald-600/80 leading-normal mt-0.5 font-semibold">Everything is running smoothly.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="relative">
            ...
            >
              <div className="w-6 h-6 rounded-full bg-brand-green flex items-center justify-center text-white font-black text-[10px] overflow-hidden shrink-0">
                {user.name.charAt(0)}
              </div>
              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-1.5 w-44 bg-white rounded-xl shadow-xl border border-slate-100 overflow-hidden z-20">
                  <div className="px-3.5 py-2.5 border-b border-slate-100 bg-slate-50">
                    <p className="text-xs font-black text-brand-green-dark truncate">{user.name}</p>
