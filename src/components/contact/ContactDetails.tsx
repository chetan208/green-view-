...
export default function ContactDetails() {
  return (
    ...
    >
      <h2 className="text-2xl font-medium md:font-semibold text-[#1f2937]" style={{ fontFamily: "Georgia, serif" }}>
        Get in Touch
      </h2>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex gap-4 items-start">
          ...
          <div className="flex flex-col pt-1">
            <h3 className="font-medium md:font-semibold text-slate-800 text-sm md:text-base">Address</h3>
        ...
        <div className="flex gap-4 items-start">
          ...
          <div className="flex flex-col pt-1">
            <h3 className="font-medium md:font-semibold text-slate-800 text-sm md:text-base">Phone</h3>
        ...
        <div className="flex gap-4 items-start">
          ...
          <div className="flex flex-col pt-1">
            <h3 className="font-medium md:font-semibold text-slate-800 text-sm md:text-base">Email</h3>
        ...
        <div className="flex gap-4 items-start">
          ...
          <div className="flex flex-col pt-1">
            <h3 className="font-medium md:font-semibold text-slate-800 text-sm md:text-base">School Timings</h3>
      ...
      <div className="bg-[#f8fafc] rounded-2xl p-6 mt-4">
        <h3 className="font-medium md:font-semibold text-slate-800 text-sm mb-4">Follow Us</h3>
