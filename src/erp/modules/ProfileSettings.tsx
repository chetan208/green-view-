...
import { User, Save, Loader2, Image as ImageIcon, Briefcase, BookOpen, AlertCircle, Phone, CheckCircle2 } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { authApi } from "@/services/erpApi";

export default function ProfileSettings({ user, onProfileUpdated }: { user: any; onProfileUpdated?: () => void }) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6 flex flex-col items-center text-center">
            <div className="w-24 h-24 rounded-full bg-slate-100 border-4 border-white shadow-sm flex items-center justify-center overflow-hidden mb-4 relative group">
              {user?.photoUrl ? (
          ...
          <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-5 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Employee ID</p>
