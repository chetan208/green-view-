  ...
  return (
    ...
    >
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        {/* Carry-forward note */}
        <div className="bg-brand-green/4 border border-brand-green-dark/10 rounded-xl px-4 py-3 flex items-start gap-2.5">
          <Clock size={14} className="text-brand-green-dark shrink-0 mt-0.5" />
