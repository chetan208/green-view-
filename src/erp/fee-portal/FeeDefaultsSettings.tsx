  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-5">
        ...
        {/* Info note */}
        <div className="flex items-start gap-2.5 bg-brand-green/4 border border-brand-green-dark/10 rounded-xl px-4 py-3 mb-5">
        ...
        {loading ? (
          <div className="space-y-5 animate-pulse">
            ...
            <div className="h-10 w-32 bg-brand-green/20 rounded-xl"></div>
          </div>
        ) : (
