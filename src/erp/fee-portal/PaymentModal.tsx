        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
          ...
          >
            <div className="px-5 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
              <h3 className="text-xs font-black uppercase tracking-wider text-brand-green-dark flex items-center gap-1.5">
            ...
            <form onSubmit={onSubmit} className="p-6 space-y-5">
              <div className="p-3 bg-slate-50 border border-slate-100 rounded-xl">
                ...
                <p className="text-sm font-black text-brand-green-dark mt-0.5">{selectedFee.month}</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#093C5D]/15 focus:border-brand-green-dark"
                />
              </div>
