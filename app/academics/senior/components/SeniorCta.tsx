  ...
  return (
    <section className="w-full bg-gradient-to-r from-[#111827] via-[#093522] to-[#105630] py-20 px-6 md:px-12 flex justify-center text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full flex flex-col items-center relative z-10">
        <span className="text-[10px] md:text-xs font-medium md:font-semibold text-[#34d399] uppercase tracking-[0.3em] mb-4">
          2025 - 26 Session
        </span>
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium md:font-bold text-white tracking-tight leading-tight mb-5">
        ...
        <p className="text-slate-300 md:text-lg font-medium max-w-2xl mx-auto mb-10 leading-relaxed">
          Admissions open for Class XI and XII. Specialized streams in Science, Commerce, and Humanities. Apply early to secure your future at Green View.
        </p>
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <Link
            href="/contact"
            className="bg-white/10 text-white border border-white/20 hover:bg-white/20 px-8 py-3.5 rounded-full font-medium md:font-semibold text-sm tracking-wide transition-all duration-300 flex items-center gap-2"
          >
            Contact Admissions
          </Link>
        </div>
