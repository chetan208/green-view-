      ...
      >
        ...
        <div className="flex-1 p-6 md:p-8 lg:p-10 flex flex-col">
          ...
          <div className="flex items-center gap-3 mb-8 select-none">
            ...
            <h2 className="text-xl md:text-2xl font-medium md:font-bold text-slate-800 tracking-tight flex-1 text-center flex items-center justify-center gap-2">
              <span>{monthName}</span>
          ...
          <div className="grid grid-cols-7 gap-y-4 text-center text-xs md:text-sm font-medium md:font-semibold text-slate-400 mb-6 select-none">
                ...
                {days.map((dayNum, idx) => {
                  ...
                  return (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.92 }}
                      className={`w-10 h-10 md:w-11 md:h-11 flex items-center justify-center font-medium md:font-semibold text-sm rounded-full transition-colors select-none ${
                        isSelected
        ...
        <div className="w-full md:w-[380px] lg:w-[420px] bg-slate-50/80 p-6 md:p-8 border-t md:border-t-0 md:border-l border-slate-100 shrink-0 flex flex-col justify-start">
          ...
          <div className="flex items-center gap-2 mt-4 md:mt-6 border-b border-slate-100 pb-3">
            ...
            <h3 className="font-medium md:font-bold text-slate-800 text-sm md:text-base tracking-tight uppercase">Monthly Events</h3>
          </div>
                ...
                {currentEvents.length > 0 ? (
                  currentEvents.map((event) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-colors font-medium md:font-semibold text-sm ${
                        ...
                        <div className="flex flex-col justify-center">
                          <h4 className={`text-xs md:text-sm font-medium md:font-bold transition-colors leading-snug ${
