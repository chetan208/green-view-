  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 pt-12 md:pt-16 pb-6 md:pb-8 flex flex-col gap-4">
      <div className="text-sm font-medium text-slate-500">
        <Link href="/" className="text-brand-green hover:underline">Home</Link> / <span className="text-slate-400">Academics</span> / <span>Study Material</span>
      </div>
      <h1 className="text-4xl md:text-5xl font-medium md:font-bold text-slate-900 tracking-tight" style={{ fontFamily: "Georgia, serif" }}>
        Study <span className="text-brand-green-dark">Material</span>
      </h1>
