      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="flex flex-col gap-3 bg-[#fcfcfc] border border-emerald-100 rounded-2xl p-4">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className={`text-sm font-semibold md:font-bold ${documents.slc ? "text-slate-900" : "text-slate-700"}`}>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className={`text-sm font-semibold md:font-bold ${documents.marksheet ? "text-slate-900" : "text-slate-700"}`}>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className={`text-sm font-semibold md:font-bold ${documents.character ? "text-slate-900" : "text-slate-700"}`}>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className={`text-sm font-semibold md:font-bold ${documents.category ? "text-slate-900" : "text-slate-700"}`}>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-5 md:p-6">
            <h4 className="text-xs font-semibold md:font-bold text-slate-800 mb-3">Declaration Terms & Conditions:</h4>
          ...
          <div className="flex flex-col gap-1">
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className={`text-[11px] font-semibold md:font-bold leading-tight ${showErrors && !acceptedTerms ? "text-red-500" : "text-slate-700"}`}>
