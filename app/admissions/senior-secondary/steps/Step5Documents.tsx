    ...
    <div className="w-full bg-white rounded-2xl border border-slate-200 shadow-sm p-5 md:p-8 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        ...
        <div className="flex flex-col gap-6">
          <h3 className="text-sm font-medium md:font-bold text-emerald-900 tracking-tight mb-2">Supported Document Checklist</h3>
          ...
          <div className="flex flex-col gap-3 bg-[#f9fafb] border border-emerald-100 rounded-2xl p-4">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className={`text-sm font-medium md:font-semibold ${documents.slc ? "text-slate-900" : "text-slate-700"}`}>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className={`text-sm font-medium md:font-semibold ${documents.marksheet ? "text-slate-900" : "text-slate-700"}`}>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className={`text-sm font-medium md:font-semibold ${documents.character ? "text-slate-900" : "text-slate-700"}`}>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className={`text-sm font-medium md:font-semibold ${documents.category ? "text-slate-900" : "text-slate-700"}`}>
          ...
          <div className="flex flex-col mt-4">
            <label className="text-[11px] font-medium md:font-semibold text-slate-800 mb-3 uppercase tracking-wider">Extracurricular Achievements & Sports Level</label>
            <textarea 
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-sm font-medium md:font-bold text-emerald-900 tracking-tight">Rules, Regulations & Declaration</h3>
          </div>
          
          <div className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-5 md:p-6">
            <h4 className="text-xs font-medium md:font-semibold text-slate-800 mb-3">Declaration Terms & Conditions:</h4>
          ...
          <div className="flex flex-col gap-1">
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className={`text-[11px] font-medium md:font-semibold leading-tight ${showErrors && !acceptedTerms ? "text-red-500" : "text-slate-700"}`}>
            ...
            {showErrors && !acceptedTerms && <span className="text-[10px] font-medium md:font-semibold text-red-500 pl-7">You must accept the terms to proceed.</span>}
          </div>
