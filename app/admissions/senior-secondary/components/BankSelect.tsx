        ...
        <div className="absolute top-full left-0 w-full mt-2 bg-white border border-slate-200 rounded-xl shadow-lg z-50 overflow-hidden flex flex-col max-h-60">
          ...
          <div className="overflow-y-auto flex-1 p-1">
            {showManualEntry && (
              ...
              >
                <span className="font-medium md:font-semibold">Use "{search.trim().toUpperCase()}"</span>
                <span className="text-[10px] font-medium md:font-semibold bg-blue-100 px-1.5 py-0.5 rounded text-blue-800">Custom Bank</span>
              </div>
            )}
            ...
            {filteredBanks.map((bank) => (
              ...
              >
                <span className={value === bank ? "font-medium md:font-semibold text-emerald-700" : ""}>{bank}</span>
