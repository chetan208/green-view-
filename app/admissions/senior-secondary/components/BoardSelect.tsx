          ...
          <div className="overflow-y-auto flex-1 p-1">
            {showManualEntry && (
              ...
              >
                ...
                <span className="text-[10px] font-medium md:font-semibold bg-blue-100 px-1.5 py-0.5 rounded text-blue-800">Custom</span>
              </div>
            )}
            ...
            {filteredBoards.map((board) => (
              ...
              >
                <span className={value === board ? "font-medium md:font-semibold text-emerald-700" : ""}>{board}</span>
