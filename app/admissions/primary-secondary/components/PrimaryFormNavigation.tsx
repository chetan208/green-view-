  ...
  return (
    <div className="w-full bg-white rounded-2xl border border-slate-200 shadow-sm p-4 md:p-5 flex items-center justify-between mt-6">
      <button 
        ...
        className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-normal md:font-medium text-sm transition-colors ${
          currentStep === 1 
      ...
      <button 
        onClick={onNext}
        className="flex items-center gap-2 px-6 py-2.5 rounded-xl font-normal md:font-medium text-sm bg-brand-green text-white hover:bg-emerald-600 transition-colors shadow-md shadow-brand-green/20"
      >
